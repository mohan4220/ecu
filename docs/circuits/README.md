...
- F1 **3 A**: real board draw is ≈0.45 A (buck ~0.13 A, coils 0.20 A, D+ 0.10 A, DIN wetting 13 mA). A 5 A blade is 11× the load and could not clear a 1 A internal fault; 3 A tightens coverage while still clearing the C9 inrush (I²t ≈ 0.8 A²s against a ~3.5 A²s melt).
